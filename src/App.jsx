...
function App() {
  ...
  const partners = [
    ...
    { 
      id: 4, logo: client4, name: 'Paragon Kindergarten and School', address: 'Paragon Road, Arani Pourashabha, Arani, Bagha, Rajshahi', totalStudents: 520,
    ...
    { 
      id: 6, logo: client6, name: 'Rajshahi Cantonment Board School & College', address: 'Rajshahi Cantonment, Rajshahi', totalStudents: 450,
    ...
    { 
      id: 11, logo: client11, name: 'Rajshine Academy', address: 'Uposhohor, Rajshahi', totalStudents: 300,
      review: "Very innovative and helpful. Our admission process is now 100% digital."
    },
    { 
      id: 12, logo: client12, name: 'Rajshahi University School,Rajshahi.', address: 'Rajshahi University, Rajshahi', totalStudents: 2400,
      review: "Their management system has completely transformed our daily operations. Truly efficient!"
    },
    { 
      id: 13, logo: client13, name: 'Islah Academy', address: 'Nawdapara Sugar Center,Sopura Rajshahi', totalStudents: 500,
      review: "The user interface is so simple that our teachers and parents adapted to it instantly."
    },
    { 
      id: 14, logo: client14, name: 'Mashkata Dighi Multi (Tech) High School And College', address: 'Katakhali,Rajshahi', totalStudents: 2300,
      review: "The best administrative tool we've ever used. It saved us a huge amount of paperwork."
    },
    { 
      id: 15, logo: client15, name: 'MATUAIL HAZI ABDUL LATIF BHUIYAN COLLEGE', address: 'Matuail Dakkhin Para,College Road,Demra(Jatrabari),Dhaka-1362', totalStudents: 700,
      review: "Reliable, fast, and secure. Our data management has never been this smooth."
    },
    { 
      id: 16, logo: client16, name: 'Moudubi Govt. High School', address: 'Moudubi,Patuakhali', totalStudents: 500,
      review: "An excellent platform that helps us track student progress with just a few clicks."
    },
    { 
      id: 17, logo: client17, name: 'M S Cadet Coaching', address: '81, Central Basabo,Dhaka', totalStudents: 200,
      review: "Their support team is amazing. They are always ready to help whenever we need them."
    },
    { 
      id: 18, logo: client18, name: 'Peace School & College Bogura', address: 'bogura', totalStudents: 500 ,
      review: "Highly affordable and effective. It's the perfect solution for modern institutions."
    },
    { 
      id: 19, logo: client19, name: 'Proyas Coaching Home', address: 'Uddyam -7 (1st Floor), Lamabazar, Sylhet', totalStudents:300,
      review: "The automated report card system has made our lives so much easier. Exceptional work!"
    },
    { 
      id: 20, logo: client20, name: 'Ranihati Degree Collage', address: 'Ranihati, Chapainawabganj', totalStudents: 975,
      review: "Great features and very professional layout. We are very happy with the service"
    },
    { 
      id: 21, logo: client21, name: 'Rifats Learning Point', address: 'Riaz Mansion, Subidbazar Point, Sylhet.', totalStudents: 500,
      review: "Even with a large number of students, the system runs perfectly without any lag."
    },
    { 
      id: 22, logo: client22, name: 'TEJDASKATHI COLLEGE', address: 'Tejdaskathi, Pirojpur', totalStudents: 350,
      review: "Very innovative and helpful. Our admission process is now 100% digital."
    },
    { 
    ...
    { 
      id: 24, logo: client24, name: 'Khulna Collectorate Public School and College', address: 'College Bhaban, Zilla School, Khulna', totalStudents: 1500,
      review: "The exam management module is a lifesaver for our teachers during peak times."
    },
    { 
      id: 25, logo: client25, name: 'Khilgaon Govt. Colony School & College', address: 'Block-C,Khilgaon, Dhaka-1219', totalStudents: 1200,
      review: "The colorful and easy interface makes it fun for our staff to manage records"
    },
    { 
      id: 26, logo: client26, name: 'Lion School and College, Khulna', address: 'Sher e Bangla Road, Gollamari', totalStudents: 500,
      review: "Our communication with parents has improved significantly since we started using this."
    },
    { 
      id: 27, logo: client27, name: 'Syeda Hasina Khatun Secondary School ', address: 'Jahanpur,Moglabazar, Dakshin Surma, Sylhet', totalStudents:500,
      review: "Professional, reliable, and modern. It fits perfectly with our digital school vision."
    },
    { 
      id: 28, logo: client28, name: 'Pinnacle Study Home', address: 'Ghoramara, Rajshahi', totalStudents: 500,
      review: "We appreciate the frequent updates and new features they provide regularly."
    },
    { 
      id: 29, logo: client29, name: 'Rajshahi Darus Salam Kamil Madrasah', address: 'Rajshahi Court, Rajpara, Rajshahi ', totalStudents: 2000,
      review: "Managing student data has become very organized and easy to access now.."
    },
    { 
      id: 30, logo: client30, name: 'YAqubia Girls High School & College Bogura', address: 'Suttrapur, Bogura Sadar, Bogura', totalStudents: 3500,
      review: "Fantastic support! They always listen to our feedback and improve the system."
    },
    { 
      id: 31, logo: client31, name: 'NEKJAN GIRLS HIGH SCHOOL', address: 'BHOLAHAT,Chapainawabganj', totalStudents: 450,
      review: "We love the intuitive design and how it connects teachers, students, and parents."
    },
    { 
      id: 32, logo: client32, name: 'FENI GIRISH-AKSHAY ACADEMY', address: 'G. A. Academy Road, Feni Sadar, Feni-3900', totalStudents: 2500,
      review: "Professional, reliable, and modern. It fits perfectly with our digital school vision."
    },
    { 
      id: 33, logo: client33, name: 'HAMIDPUR NAWDAPARA HIGH SCHOOL', address: 'Nawdapara, Airport Road', totalStudents: 800,
      review: "The exam management module is a lifesaver for our teachers during peak times."
    },
    { 
      id: 34, logo: client34, name: 'Bashirabad Dawatul Islam Fazil Madrasah', address: 'Bashirabad, Kharkhari, Paba,  Rajshahi', totalStudents: 500,
      review: "Professional, reliable, and modern. It fits perfectly with our digital school vision."
    },
    { 
      id: 35, logo: client35, name: 'AMIRJAN HIGH SCHOOL', address: 'DUMNI, TALNA, KHILKHET, DHAKA - 1229', totalStudents:1300,
      review: "The colorful and easy interface makes it fun for our staff to manage records"
    },
    { 
      id: 36, logo: client36, name: 'AMBIA KINDER GARTEN SCHOOL', address: 'College Road, Kamalganj-3220, Moulvibazar, Bangladesh.', totalStudents: 400,
      review: "Professional, reliable, and modern. It fits perfectly with our digital school vision."
    },
    { 
      id: 37, logo: client37, name: 'AGRANI BIDYALAYA O MAHABIDYALAYA', address: 'Ruet Area, Rajshahi', totalStudents: 3500,
      review: "The exam management module is a lifesaver for our teachers during peak times."
    },
    { 
      id: 38, logo: client38, name: 'Advanced Academy', address: 'Bosua (Alir Mor ),Rajshahi', totalStudents: 500,
      review: "Professional, reliable, and modern. It fits perfectly with our digital school vision."
    },
    { 
      id: 39, logo: client25, name: 'Khilgaon Govt. Colony School and College (Primary)', address: ' Block-C,Khilgaon, Dhaka-1220', totalStudents: 500,
      review: "Professional, reliable, and modern. It fits perfectly with our digital school vision."
    },
    { 
      id: 40, logo: client11, name: 'Radiant Public School', address: 'Sadhur Mor, Talaimari, Rajshahi', totalStudents: 500,
      review: "Our communication with parents has improved significantly since we started using this."
    },
    { 
      id: 41, logo: client25, name: 'Khilgaon Govt. Colony School&College{College}', address: ' Block-C,Khilgaon, Dhaka-1221', totalStudents: 500,
      review: "Professional, reliable, and modern. It fits perfectly with our digital school vision."
    },
    { 
      id: 42, logo: client39, name: 'Rajshahi Cantonment Board School & College', address: 'Rajshahi Cantonment, Rajshahi', totalStudents: 450,
      review: "Professional, reliable, and modern. It fits perfectly with our digital school vision."
    },
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gradient-to-br from-white via-cyan-50/30 to-white overflow-hidden">
        ...
        <div className="relative w-full overflow-hidden">
          ...
          <div className="animate-marquee-infinite py-4 flex gap-6">
            {scrollItems.map((partner, idx) => (
              <div
                key={`${partner.id}-${idx}`}
                onClick={() => setSelectedPartner(partner)}
                className="flex-shrink-0 w-44 h-28 bg-white border border-gray-200 rounded-2xl flex flex-col items-center justify-center gap-2 px-3 cursor-pointer shadow-sm transition-all duration-300 hover:-translate-y-2 hover:scale-105 hover:shadow-lg hover:shadow-cyan-200 hover:border-cyan-400"
              >
                <img
                  src={partner.logo}
                  alt={partner.name}
                ...
                />
                <span className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest truncate w-full text-center px-2">
                  {partner.name}
                </span>
              </div>
            ))}
        ...
        <div className="mt-5 flex justify-end">
          <a 
            href="/clients" 
            className="group flex items-center gap-2 px-6 py-3  text-cyan-600 font-bold  transition-all duration-300  "
          >
            See All Partners
            <svg 
